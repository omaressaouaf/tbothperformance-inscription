...
return [
    ...
    */
    ...
    "date_between" => "The field :attribute must fall in between :start and :end",
    ...
    */
    ...
    'custom' => [
        'city_id' => [
            'required_if' => "The city field is required.",
        ],
        'ids' => [
            'required' => "The selected items are required.",
        ],
    ],
